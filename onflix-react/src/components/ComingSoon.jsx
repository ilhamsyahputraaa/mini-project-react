...
function ComingSoon() {
    ...
    Axios({
        method: 'get',
        url: 'https://api.themoviedb.org/3/movie/upcoming?api_key=aa4cf977385f47ebf8160e43b648a495&page=1&region=US&language=en-US',
    })
                        ...
                        <div className="text-container position-absolute" >
                            <div className="info-icons">
                                <span className="info-label">
                                    <img src={TimeIcon} alt="" />{movie.release_date}</span>
                                <span className="info-label">
                                    <img src={ReleaseIcon} alt="" />ID{movie.id}</span>
                            </div>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="container-fluid d-flex modal-content-container">
                            ...
                            <div className="col-7 modal-description">
                                ...
                                <span >
                                    <span className="info-label-modal"> <img src={TimeIcon} alt={movie.title}/>{movie.release_date}</span>
                                    <span className="info-label-modal"> <img src={ReleaseIcon} alt={movie.title}/>ID-{movie.id}</span>
